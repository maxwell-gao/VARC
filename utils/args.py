...
def add_speed_optimizer_args(parser: argparse.ArgumentParser) -> None:
    parser.add_argument(
        "--no-compile",
        action="store_true",
        help="Disable torch.compile optimization (useful for debugging).",
    )
    parser.add_argument(
        "--compile-mode",
        type=str,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train ARC-specific Vision Transformer."
    )
    ...
    parser.add_argument(
        ...
        default="medium",
        help="Choose the size of UNet wanted; small, medium, or big. Only applies if architecture==unet",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Number of task tokens to use in the model.",
    )
    parser.add_argument(
        "--lr-scheduler", type=str, default="cosine", choices=("none", "cosine")
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional path to store the final trained checkpoint",
    )
    parser.add_argument(
        "--best-save-path",
        type=str,
        default=None,
        help="Optional path to store the checkpoint achieving the best evaluation accuracy.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="Number of attempts per evaluation example.",
    )
    parser.add_argument(
        "--eval-save-name",
        type=str,
        default=None,
        help="Name for saving evaluation predictions.",
    )
